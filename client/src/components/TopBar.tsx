...
export default function TopBar() {
  ...
  return (
    <header className="bg-surface border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between md:px-6 sm:px-4 sticky top-0 z-50 h-16 sm:h-20">
