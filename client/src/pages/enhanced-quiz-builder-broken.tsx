...
export default function EnhancedQuizBuilder() {
  ...
  const [quiz, setQuiz] = useState<Partial<Quiz>>({
    ...
    attemptSettings: {
      maxAttempts: 1,
      attemptGap: 0,
      attemptGapUnit: "minutes" as const,
      ...
      <div className="space-y-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <TabsContent value="questions" className="space-y-6">
              {/* Toggle between Item Bank Questions and Quiz Questions */}
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="questionView" className="text-sm font-medium">
                      {viewingQuizQuestions ? "Show Quiz Questions" : "Show Item Bank Questions"}
                    </Label>
                  </div>
                  <div className="text-sm text-muted-foreground">
                    {viewingQuizQuestions 
                      ? `${selectedQuestions.length} questions in this quiz`
                      : "Browse questions from your item banks"
                    }
                  </div>
                </div>
                <Button 
              ...
              <Card>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle className="flex items-center gap-2">
                        ...
                        {viewingQuizQuestions ? "Quiz Questions" : "Question Bank Selection"}
                      </CardTitle>
                      <CardDescription>
                        {viewingQuizQuestions 
                ...
                <CardContent>
                  {viewingQuizQuestions ? (
                    // Show questions already added to this quiz
                    <div className="space-y-4">
                    ...
                    // Show item bank questions for selection
                    <div>
                      {questionsLoading ? (
